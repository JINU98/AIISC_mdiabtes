	...
	return (
		<SafeAreaView style={styles.root}>	
            ...
            <View>
             ...
             <Row style={{ height: 40 }}>
                    <Col ><Text style ={styles.cell}>Total</Text></Col>
                    <Col><Text style ={styles.cell}>{Object.values(foodCarbMap).reduce((partialSum, a) => partialSum + a, 0)}
                    </Text></Col>
                    <Col><Text style ={styles.cell}></Text></Col>
                    </Row>
            </View>
            ...
            <Text style={{color:"#000",marginBottom:20,textAlign:"center",marginTop:12}} >App calculated estimation</Text> 
            </View>
            ...
            <Text style={{color:"#000",marginBottom:20,textAlign:"center",marginTop:12}} >My own estimation</Text> 
            </View>
