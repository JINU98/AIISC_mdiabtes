...
export default function LogFood({ route, navigation }) {
	...
	// console.log("foooooooooood",food)
		...
		let url = "http://192.168.1.4:8080/api1";
		...
		.then((res) => {
			...
			fetch(`http://192.168.1.4:8080/download/${JSON.stringify(res.download)}`)
			.then((res) => res)
			.then((res) => { 
		...
		return (
			<ScrollView style={styles.root}>
				...
				<View style={styles.food}>
					...
					{topView == null ? 
						<TouchableOpacity >
							<IconButton size={50} icon="camera" onPress={() => {navigation.navigate("FoodCamera", { direction: "top" })}} />
						</TouchableOpacity> 
						:
				...
				<View style={styles.food}>
					...
					{sideView == null ? 
						<TouchableOpacity>
							<IconButton size={50} icon="camera"  onPress={() => {navigation.navigate("FoodCamera", { direction: "side" })}} />
						</TouchableOpacity>
						:
